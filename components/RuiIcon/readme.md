...
The icon component can be used in places where hover states are required. Icon allows the configuration for transition and hover colour

```html preview
<rui-icon src="/icons/chat.svg" hover={true}></rui-icon>
<rui-icon src="/icons/world.png" hover={true}></rui-icon>
